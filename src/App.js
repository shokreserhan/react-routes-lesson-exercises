  ...
  constructor() {
    ...
    this.state = {
      ...
      bestiary: [
        ...
        { name: "Buckbeak", power: "Flying", other: "Knocked over Malfoy like a boss", imgUrl: "https://tinyurl.com/buckbeak-img" },
  ...
  render() {
    ...
    return (
      ...
      <div className="App">
        ...
        <Route exact path="/directory/:fentities/:name" render={({match}) => <Fentity match={match} state={state} />} />
        {/* Routes go here ^ */}
      </div>
      </Router>
    );
